...
export const Visitor = () => {
  ...
  const [sealedResultModalVisible, setSealedResultModalVisible] =
    useState(false);
  ...
  const runTests = async () => {
    ...
    const tests = [
      ...
      () => fingerprintClient.getVisitorId(undefined, 'checkId'),
      () => fingerprintClient.getVisitorData(undefined, 'checkData'),
      ...
      () => fingerprintClient.getVisitorId(undefined, undefined, {timeout: 5_000}),
      () => fingerprintClient.getVisitorData(undefined, undefined, {timeout: 5_000}),
    ];

    const timeoutTests = [
      () => fingerprintClient.getVisitorId(undefined, undefined, {timeout: 5}),
      () => fingerprintClient.getVisitorData(undefined, undefined, {timeout: 5}),
    ];
  ...
  return (
    <View style={styles.centeredView}>
      <View style={styles.buttonsBlock}>
        ...
        <Button
          title="Load with tag and linkedId"
          onPress={onLoadDataWithTag}
        />
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Button
              title="Close"
              onPress={() =>
                setSealedResultModalVisible(!sealedResultModalVisible)
              }
            />
          </View>
        </View>
